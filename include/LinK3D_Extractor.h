...
#define distPt2Pt(a, b) sqrt((a.x - b.x) * (a.x - b.x) + (a.y - b.y) * (a.y - b.y) + (a.z - b.z) * (a.z - b.z))
    ...
    public:
        ...
        void computeDirection(pcl::PointXYZI ptFrom, pcl::PointXYZI ptTo, Eigen::Vector2f &direction);

        vector<pcl::PointXYZI> getMeanKeyPoint(const ScanEdgePoints &clusters, ScanEdgePoints &validCluster);
